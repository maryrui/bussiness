        ...
        <el-table fit highlight-current-row style="width:100%;" :data="list">
            ...
            <el-table-column label="操作" align="center">
                <template slot-scope="scope">
                    <el-button type="primary" size="mini" icon="el-icon-edit" :disabled="scope.row.isDeleted ? true :false" @click="clickEditBtn(scope.row.storeContent_id)" v-if="isAuth('role:indexArticleList:edit')">编辑</el-button>
                    <el-button type="danger" size="mini" icon="el-icon-remove-outline" @click="removeBtn(scope.$index,scope.row)"  v-if="isAuth('role:indexArticleList:del')">删除</el-button>
                </template>
            </el-table-column>
        </el-table>
