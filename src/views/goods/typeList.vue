    ...
    <div class="typeList_box">
        ...
        <el-table :data="dataList">
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                    <p><el-button type="primary" size="mini" @click="scope.row.isEditor=1" v-if="!scope.row.isEditor">编辑</el-button><el-button type="success" size="mini" @click="submit(scope.$index,scope.row)" v-else>确定</el-button></p>
...
<script>
    import {getTypeLists,addType,removeType} from '@/api/goods'
